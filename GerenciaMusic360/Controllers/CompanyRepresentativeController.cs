...
namespace GerenciaMusic360.Controllers
{
    ...
    public class CompanyRepresentativeController : ControllerBase
    {
        ...
        [Route("api/CompanyRepresentatives")]
        [HttpGet]
        public MethodResponse<List<Person>> Get()
        {
            ...
            try
            {
                result.Result = _personService.GetAllPersons((int)Entity.CompanyRepresentative)
                    .ToList();
            }
            catch (Exception ex)
            {
        ...
        [Route("api/CompanyRepresentative")]
        [HttpGet]
            ...
            try
            {
                ...
                if (model.PictureUrl?.Length > 0)
                    pictureURL = _helperService.SaveImage(
                        ...
                        "companyRepresentative", $"{Guid.NewGuid()}.jpg",
                        _env);
                ...
                model.EntityId = (int)Entity.CompanyRepresentative;
        ...
        [Route("api/CompanyRepresentativeStatus")]
        [HttpPost]
