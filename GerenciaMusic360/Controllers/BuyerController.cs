...
namespace GerenciaMusic360.Controllers
{
    ...
    public class BuyerController : ControllerBase
    {
        ...
        public MethodResponse<List<Person>> Get()
        {
            ...
            try
            {
                result.Result = _personService.GetAllPersons((int)Entity.Buyer)
                    .ToList();
            }
            catch (Exception ex)
            {
        ...
        public MethodResponse<int> Post([FromBody] Person model)
        {
            ...
            try
            {
                ...
                model.EntityId = (int)Entity.Buyer;
                model.StatusRecordId = 1;
                model.PersonTypeId = null;
