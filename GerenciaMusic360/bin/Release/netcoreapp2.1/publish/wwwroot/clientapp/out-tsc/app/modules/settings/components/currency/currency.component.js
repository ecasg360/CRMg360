...
var CurrencyComponent = /** @class */ (function () {
    function CurrencyComponent(toasterService, service, dialog, router, translate, route, _fuseTranslationLoaderService) {
        var _a;
        ...
        this.displayedColumns = ['code', 'key', 'status', 'action'];
    ...
    CurrencyComponent.prototype.showModalForm = function (id) {
        var _this = this;
        if (id === void 0) { id = 0; }
        var dialogRef = this.dialog.open(AddCurrencyComponent, {
            width: '500px',
            data: {
                id: id
            }
    ...
    CurrencyComponent.prototype.confirmDelete = function (id, name) {
        var _this = this;
    ...
    CurrencyComponent.prototype.deleteType = function (id) {
        var _this = this;
        this.isWorking = true;
        var params = [];
        params['id'] = id;
    ...
    CurrencyComponent.prototype.updateStatus = function (id, status) {
        var _this = this;
    ...
    CurrencyComponent.prototype.responseError = function (error) {
